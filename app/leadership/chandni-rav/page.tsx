...
export default function ChandniRavPage() {
  return (
    <>
      {/* ── Hero ── */}
      <section className="ldr-hero">
        <div className="ldr-hero__left">
          <div className="ldr-hero__content">
            ...
            <h1 className="ldr-name">Chandni Rav</h1>
            <p className="ldr-role">CHIEF BUSINESS OFFICER</p>
            ...
            <p className="ldr-body">
              Chandni works alongside the Oltraya leadership team before key decisions are finalised — bringing clarity, strategic foresight and a deep understanding of human behaviour to shape better outcomes for our customers.
            </p>
        ...
        <div className="ldr-hero__right">
          <Image src="/leadership_hero.png" alt="Chandni Rav" fill style={{ objectFit: 'cover' }} priority sizes="60vw" />
        </div>
      </section>
        ...
        <div className="container">
          <div className="ldr-split">
            ...
            <div className="ldr-split__left">
              <SectionLabel text="CHANDNI'S THINKING" />
              ...
              <p className="ldr-body" style={{ marginTop: 32, marginBottom: 40 }}>
                At Oltraya, behavioral science is integrated before key decisions are made — helping align land selection, positioning, design philosophy, customer experience and long-term vision.
              </p>
            ...
            {[
              {
                ...
                desc: 'Chandni brings behavioral scientific lens to challenge assumptions and protect the long-term vision.',
              },
              {
                icon: (
                  <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round">
      ...
      <style jsx>{`
        ...
        .ldr-working-card__desc {
          font-size: 0.82rem;
          line-height: 1.65;
          color: rgba(10, 18, 42, 0.75);
        }
        ...
        .ldr-insight-card__image {
          position: relative;
          height: 140px;
          overflow: hidden;
          background: var(--ivory-darker);
        }
        .ldr-insight-card:hover .ldr-insight-card__image img {
          transform: scale(1.04);
        }
        .ldr-insight-card__title {
          font-size: 0.82rem;
          line-height: 1.4;
          color: var(--prussian);
          font-weight: 500;
        }
        .ldr-insight-card__read {
          font-size: 0.65rem;
