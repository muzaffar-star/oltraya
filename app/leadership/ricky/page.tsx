...
export default function RickyYolePage() {
  return (
    <>
      {/* ── Hero ── */}
      <section className="ldr-hero">
        <div className="ldr-hero__left">
          <div className="ldr-hero__content">
            ...
            <h1 className="ldr-name">Ricky Yeole</h1>
            <p className="ldr-role">PARTNER & CHIEF OPERATING OFFICER</p>
            ...
            <p className="ldr-body">
              Ricky works alongside the Oltraya leadership team before key decisions are finalised — bringing clarity, strategic foresight and a deep understanding of human behaviour to shape better outcomes for our customers.
            </p>
        ...
        <div className="ldr-hero__right">
          <Image src="/leadership_hero.png" alt="Ricky Yeole" fill style={{ objectFit: 'cover' }} priority sizes="60vw" />
        </div>
      </section>
